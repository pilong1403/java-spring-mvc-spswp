                ...
                <div class="mt-5">
                    <div class="row">
                        <div class="col-md-6 col-12 mx-auto">
                            ...
                            <hr>
                            <form:form method="POST" action="/admin/product/update" modelAttribute="product" enctype="multipart/form-data" class="row">
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <fmt:formatNumber type="number"
                                                      ...
                                                      var="price"/>
                                    <form:input type="number" step="1" class="form-control ${not empty errorPrice ? 'is-invalid' : ''}" min="0.00" path="price" value="${price}"/>
                                    ${errorPrice}
                                </div>
                                <div class="col-12 mb-3">
                                    ...
                                    <form:textarea cols="3" class="form-control ${not empty errorDetailDesc ? 'is-invalid' : ''}" path="detailDesc"/>
                                    ${errorDetailDesc}
                                </div>
                                <div class="col-12 col-md-6 mb-3">
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <form:input type="number" class="form-control ${not empty errorQuantity ? 'is-invalid' : ''}" min="0" path="quantity"/>
                                    ${errorQuantity}
                                </div>
                                <div class="col-12 col-md-6 mb-3">
                                ...
                                <div class="col-12 mb-3">
                                    <img style="width: fit-content;" src="/images/product/${product.image}" id="imagePreview" alt="image preview"/>
                                </div>
